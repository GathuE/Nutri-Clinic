						...
						<div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form enctype="multipart/form-data" method="post" action="classes/nutritionist_record_payment">
                                ...
                                <div class="card-action">
                                    <a class="btn btn-success" href="nutritionist_performance_details?view=<?php echo $staffid; ?>">Back To Performance</a>
                                </div>
                            <!-- Place Other Contents Here -->
