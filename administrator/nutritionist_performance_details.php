				...
				<div class="content">
						<div class="container-fluid">
							...
							<?php 
								...
								INNER JOIN nutritionist_data ON nutritionists.ID=nutritionist_data.nutritionist_id 
                                WHERE nutritionists.email='$email'";
                                    ...
                                    <div class="card" id="employee_card">
										<h6 id="employee_heading">Employee Details</h6>
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                <form method="post" action="nutritionist_record_payment">
                                                    <div class="row">
                                                        <div class="col-sm-12">
