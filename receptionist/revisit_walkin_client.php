...
if (!isset($_SESSION['logged_in'])) {
  ...
  exit();
	...
	{
		$title = "Firm Name || Revisit Client";
		$page_title = "Revisit Client";
						...
						<div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                                <form method="post" action="classes/record_revisitclient">
                                                    <div class="row">
                                                        <div class="col-sm-6 col-md-6">
                                                            <div class="form-group">
                                                                <label for=""> Client Names :</label>
                                                                <div class="col-md-12 p-0">
                                                                    <input type="text" class="form-control input-full" name="clientname" id="clientname" value="<?php echo htmlentities($result->clientname);?>" readonly>
                                                                    <input type="hidden" class="form-control input-full" name="identity" value="<?php echo htmlentities($result->ID);?>">
                                                                    <input type="hidden" class="form-control input-full" name="status" value="Re Visit">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 p-0">
                                                                    <input type="text" class="form-control input-full" name="clientphonenumber" id="clientphonenumber" value="<?php echo htmlentities($result->phonenumber);?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 p-0">
                                                                    <select class="form-control input-square" id="service" name="service" onchange="definecost();" required>
                                                                        ...
                                                                        <option value="Consultation">Consultation &nbsp;<span>(Re-Visit)</span></option>
                                                ...
                                                <script>
                                                    ...
                                                    function definecost(){
                                                        ...
                                                        if(service == 'Consultation'){
                                                            document.getElementById("servicecost").value = "200";
                                                        }
