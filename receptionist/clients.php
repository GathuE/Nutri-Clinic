                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Walk In Clients
                                                <div class="card-title-right">
                                                    <a class="btn btn-primary btn-xs" href="new_walkin_client">Register new</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if(!isset($_POST['submit'])){
                                                            $query = "SELECT * FROM walkin_clients ORDER BY date DESC $limit";
                                                            ...
                                                            <td id="action_selector">
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="client_transaction_details?view=<?php echo $clientid;?>"><i class="la la-eye m-r-5"></i>View Transaction</a>
                                                                        <a class="dropdown-item" href="revisit_walkin_client?view=<?php echo $clientid;?>"><i class="la la-plus m-r-5"></i>Add New Transaction</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <?php
                                                            ...
                                                            $phonenumber = $_POST['phonenumber'];
                                                                ...
                                                                if($phonenumber != ""){
                                                                $query = "SELECT * FROM walkin_clients WHERE phonenumber ='$phonenumber'";
                                                                    $data = mysqli_query($con, $query) or die('error');
                                                                    $cnt=1;
                                                                    if(mysqli_num_rows($data) > 0){
                                                                        while($row = mysqli_fetch_assoc($data)){
