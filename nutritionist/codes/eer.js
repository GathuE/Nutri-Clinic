...
function divswap() {
    ...
    if (agevalue === "" || heightvalue === "" || weightvalue === "" || gendervalue === "" || workvalue === "") {
        Swal.fire({
            size: '200px',
            position: 'top-center',
            icon: 'error',
...
function EER() {
    ...
    else if (a >= 14 && a <= 18 && j == 1 && p == "yes" && l == "no" && g == "Female") {
        var eer = (135.3 - (30.8 * a) + (10 * w * 1.00)) + (934 * h / 100) + 25 + 272 + 180;
    } else if (a >= 14 && a <= 18 && j == 2 && p == "yes" && l == "no" && g == "Female") {
        var eer = (135.3 - (30.8 * a) + (10 * w * 1.12)) + (934 * h / 100) + 25 + 272 + 180;
    } else if (a >= 14 && a <= 18 && j == 3 && p == "yes" && l == "no" && g == "Female") {
        var eer = (135.3 - (30.8 * a) + (10 * w * 1.27)) + (934 * h / 100) + 25 + 272 + 180;
    } else if (a >= 14 && a <= 18 && j == 4 && p == "yes" && l == "no" && g == "Female") {
    ...
    else if (a >= 19 && a <= 30 && j == 1 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.00)) + (726 * h / 100) + 272 + 180;
    } else if (a >= 19 && a <= 30 && j == 2 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.12)) + (726 * h / 100) + 272 + 180;
    } else if (a >= 19 && a <= 30 && j == 3 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.27)) + (726 * h / 100) + 272 + 180;
    } else if (a >= 19 && a <= 30 && j == 4 && p == "yes" && l == "no" && g == "Female") {
    ...
    else if (a >= 31 && a <= 50 && j == 1 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.00)) + (726 * h / 100) + 272 + 180;
    } else if (a >= 31 && a <= 50 && j == 2 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.12)) + (726 * h / 100) + 272 + 180;
    } else if (a >= 31 && a <= 50 && j == 3 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.27)) + (726 * h / 100) + 272 + 180;
    } else if (a >= 31 && a <= 50 && j == 4 && p == "yes" && l == "no" && g == "Female") {
        var eer = (354.6 - (6.91 * a) + (9.36 * w * 1.45)) + (726 * h / 100) + 272 + 180;
    }
    ...
    document.getElementById("eer").innerHTML = "Your EER is " + eer + " " + "Kcals";
    document.getElementById("standardeer").innerHTML = "<small>The above term <b>EER</b> represents the amount of energy<b>(in Kilo Calories)</b> that your body requires every day.</small>";
    document.getElementById("illustration").innerHTML = "<small>This energy in most scenarios is obtained from the variety of foods you eat.<br>Such foods contain various nutrients that collectively contribute to the amount of energy your body needs <br> i.e <b>your EER</b>.<br>You must be now curious about <b>what amounts of nutrient(s), (contained in the foods you eat), </b>you need to take to obtain energy equivalent to your EER.<br>Clicking on the button below will answer your question.</small>";
